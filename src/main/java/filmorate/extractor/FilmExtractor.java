...
public class FilmExtractor implements ResultSetExtractor<ArrayList<Film>> {
    public ArrayList<Film> extractData(ResultSet resultSet) throws SQLException, DataAccessException {
